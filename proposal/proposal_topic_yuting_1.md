...
- 透過即時的語音與嘴型分析反饋，讓使用者能夠更有效率地糾正發音，看見 AI 示範嘴型改正，用以提升學習效果。
...
- 教材：
  - 單字發音訓練：針對語言學習的基礎，系統提供常用詞彙的發音練習，AI 會糾正發音。
  - 句子與段落訓練：讓使用者練習更長的句子和段落，提供連音、音調及語調的練習建議，提升流暢度。
  - 交談訓練：系統會模擬實際對話情境，使用者可與 AI 互動，訓練口語表達，提升生活中應用語言的能力，且能提供發音建議。
...
- Duolingo：遊戲化的語言學習應用。
- Elsa Speak：以 AI 幫助用戶提高英語的口音和發音準確度。
- EF HELLO：AI 在各章節協助整理重點。
...
- EF HELLO：AI 應用在各章節協助整理重點、深入主題背景知識和相關詞彙的說明，及時反饋。

#### 類似產品的缺點：

- Duolingo：主要還是輔助學習，不能作為主要工具。
- Elsa Speak：只著重英文口語教學，介面複雜難上手。
- EF HELLO：只著重英文口語教學，AI 口語練習真實感不足。

### 差異性

#### 差異之處：

- 以 AI 技術呈現嘴型與語音同步辨識，提供使用者即時的發音矯正，讓使用者能更直觀快速改善語音表現。
