...
- StrokeGuide 可利用鏡頭偵測筆劃順序和提供改進建議，幫助使用者提升書寫精確度與技巧。

### 目標與價值

#### 目標：

- 通過 AI 監測，使用者能夠學習正確的筆劃順序和書寫方式，進而提高書寫精確度，減少筆畫錯誤。
...
- 筆劃監測：利用 AI 監控用戶書寫的每一筆劃，檢查順序和形狀是否正確。
  - 使用者可以寫句子、詞語後，再由 AI 判斷是否有錯誤筆順或需更改的地方。
...
- 華語生字簿（師大國語教學中心）：網站使用標楷體，一頁生成最多不可超過 6 個字。
